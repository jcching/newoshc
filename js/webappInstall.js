...
// console.log(isIphoneApp);
// console.log(isChromeApp);
...
if (isMobile&&(!(isIphoneApp||isChromeApp))) {

	localStorage.onsplash=true;

	//if its mobile but not a ios or android app
	$( "body" ).load( "splash.html" );


}else{
	localStorage.onsplash=false;
}